...
export interface CompactComparisonRow {
  arcadex: string | string[]; // ArcadeX values
  others: string | string[];  // Competitor values
  icon?: React.ReactNode;      // Professional SVG icon
  highlight?: boolean;        // Highlight row
}

export const comparisonData: CompactComparisonRow[] = [
  {
    arcadex: ["24/7 Priority Support & Staff Training", "Expert Hardware Setup & Implementation"],
    others: ["No Employee Training Programs", "No Technical Support Packages"],
    icon: (
  ...
  },
  {
    ...
    others: ["Fragmented Operational Tools", "Disconnected Shop Tracking"],
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
